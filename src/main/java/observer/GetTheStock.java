...
public class GetTheStock implements Runnable {
    ...
    public void run(){
        ...
        for(int i = 1; i <= 20; i++){
            ...
            if(stock == "IBM") ((StockSubject) stockGrabber).setIbmPrice(price);
            if(stock == "AAPL") ((StockSubject) stockGrabber).setApplePrice(price);
            if(stock == "GOOG") ((StockSubject) stockGrabber).setGooglePrice(price);
